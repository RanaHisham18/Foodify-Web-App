...
<h4>Update Data</h4>
<form method="POST"> 
<input type="text" name="productname" value="<?php echo $data['name']?>" placeholder="enter name" required>>
<input type="text" name="price" value="<?php echo $data['category']?>" placeholder="enter price" required>>
